...
import CoinJoin_Construction from "@/my_tx_flows/p15_CoinJoin_Construction.json";
...
export const customFlows = [
  ...
  {
    id: "flow-15",
    label: "CoinJoin Construction",
    data: CoinJoin_Construction as unknown as FlowData,
  },
];
